defmodule Puzzle01Test do
  ...
  describe "#sum_first_last" do
    test "should sum the first and last digits found in a string" do
      assert 12 == Puzzle01.first_last("1abc2")
      assert 38 == Puzzle01.first_last("pqr3stu8vwx")
      assert 15 == Puzzle01.first_last("a1b2c3d4e5f")
      assert 77 == Puzzle01.first_last("treb7uchet")
    end

    test "should understand written integers" do
      assert 29 == Puzzle01.first_last("two1nine")
      assert 83 == Puzzle01.first_last("eightwothree")
      assert 13 == Puzzle01.first_last("abcone2threexyz")
      assert 24 == Puzzle01.first_last("xtwone3four")
      assert 42 == Puzzle01.first_last("4nineeightseven2")
